...
int drawing_mode = 0;		//0-> line strip 1-> triangle strip 2-> triangle fan
bool loop=true;
...
/* YOUR CODE HERE */
   ...
   /* Bind attribute index 0 (coordinates) to in_Position and attribute index 1 (color) to in_Color */
	...
	switch (drawing_mode){
		...
		case 2:{
			glDrawArrays(GL_TRIANGLE_FAN, 0, numverticestodraw);
			break;
		}
	}
...
int main(int argc, char *argv[])
{
	...
	while (SDL_PollEvent(&ev)) {
		...
		case SDLK_f:
		    ...
		    break;
		case SDLK_t:
			printf("Drawing with triangle fan.\n");
			drawing_mode = 2;
			break;
		case SDLK_y:
			printf("Drawing with triangle strip.\n");
			drawing_mode = 1;
			break;
		case SDLK_u:
			printf("Drawing with line strip.\n");
			drawing_mode = 0;
			break;
		}
	    }
