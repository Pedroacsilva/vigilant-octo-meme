...
GLuint VAOId_cube, VBO_cube_position, VBOCubeUV, MVPID, CubePosID, timeID, textureID;
...
void init(){
    ...
    //glDepthFunc(GL_LESS);
    if(myprog->loadShaders("cubotextures.vert","cubotextures.frag") == GL_FALSE){
    ...
    timeID = glGetUniformLocation(myprog->shaderprogram, "time");
    ...
    glVertexAttribPointer(2, 2, GL_FLOAT, GL_FALSE, 0, BUFFER_OFFSET(0));           //Dizer como os dados, vertexUV, estao estruturados aos shaders
